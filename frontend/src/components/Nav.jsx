...
import { Text, Box, Button, useColorModeValue, useColorMode, Flex} from '@chakra-ui/react';
    ...
    return (
        <Box h={"10%"} bg='gray.800' color={'white'}>
            <Flex justifyContent={'space-between'}>
                <Link to={"feed"}><Text fontWeight={'bold'} fontSize={'xx-large'} p={5} >screener.</Text></Link>
